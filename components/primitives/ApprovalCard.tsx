/* Beautiful UI — Approval Card. https://www.beautifului.dev
 * MIT License, Copyright (c) 2026 Shane Levine.
 *
 * Adapted for Adorable, where the agent's askUserTool supplies the questions: no demo
 * questions, no dismiss or start-over (the agent waits on the answers), Skip on the last
 * question sends, typed answers are handed back with the picked options, and the answers are
 * read when sending rather than from the render that started the auto-advance timer. */
"use client";
...
export default function ApprovalCard({
  ...
  /** picked option indexes and typed answers, each by question index */
  onSubmitted?: (
  ...
  // The auto-advance timer sends from an older render; these hold the answers as they are now.
      ...
      >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <label
                        data-menu-row
                        className="relative z-10 flex items-center gap-1.5 rounded-control py-1 pr-2 pl-1 transition-colors duration-100"
                      >
                        <input
                          value={custom[qIdx] ?? ""}
                          tabIndex={active ? 0 : -1}
        ...
        <div className="primitive-card-footer flex items-center justify-between gap-3">
          <div className="flex items-center gap-1 text-ink-3">
            ...
            <span
              className="inline-flex items-center text-[12px] font-medium text-ink-3 tabular-nums"
